...
def coare35vn(u, t, rh, ts, P=1015, Rs=150, Rl=370, zu=18, zt=18, zq=18, lat=45,
             ...
             zi=600, rain=None, cp=None, sigH=None, winddir=None, wavedir=None, use_mean="no", TL="no", jcool=1):
    ...
    for i in range(nits):
        ...
        zo = charn*usr**2/grav + 0.11*visa/(np.maximum(usr,0.07))  # surface roughness
        ...
        zo_visc = 0.11*visa/usr
        zo_roughS = charnS*(usr**2/grav)
        zo_roughC = charnC*(usr**2/grav)
        zo_roughW = charnW*(usr**2/grav)
    ...
    # or
    U10 = U + usr/von/gf*(np.log(10/zu) - psi10 + psi)
    ...
    list1 = [usr,tau,hsb,hlb,hbb,hsbb,hlwebb,tsr,qsr,zo,zoq,Cd,Ch,Ce,L,zet]


    list2 = [dter,dqer,tkt,Urf,Trf,Qrf,RHrf,UrfN,Rnl,Le,rhoa,UN,U10,U10N]


    list3 = [Cdn_10,Chn_10,Cen_10,RF,Evap,Qs,Q10,RH10,zo_visc,zo_roughC,zo_roughW,zo_roughS]
